...
| :------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------- | :-----------: | :-------: |
|    2025-01    | [MILS](https://github.com/facebookresearch/MILS)              | MILS: LLMs can see and hear without any training.            |[arXiv](https://arxiv.org/abs/2501.18096)  |   |
|    2024-11    | [Oasis](https://github.com/etched-ai/open-oasis)              | Oasis is an interactive world model developed by Decart and Etched. Based on diffusion transformers, Oasis takes in user keyboard input and generates gameplay in an autoregressive manner.            |  | [Hugging Face](https://huggingface.co/Etched/oasis-500m)   |
...
| Date          | Source                   | Description                                                 |   Paper   |  Model  |
| :------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------- | :-----------: | :-------: |
|    2024-10    | [TEN Agent](https://github.com/TEN-framework/TEN-Agent)                | TEN Agent is the world’s first real-time multimodal agent integrated with the OpenAI Realtime API, RTC, and features weather checks, web search, vision, and RAG capabilities.            |  |[Website](https://www.theten.ai/)  |
...
| Date          | Source                   | Description                                                 |   Paper   |  Model  |
| :------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------- | :-----------: | :-------: |
|    2024-09    | [StoryMaker](https://github.com/RedAIGC/StoryMaker)                  | StoryMaker: Towards Holistic Consistent Characters in Text-to-image Generation.            |[arXiv](https://arxiv.org/abs/2409.12576)  |[Hugging Face](https://huggingface.co/RED-AIGC/StoryMaker)  |
|    2024-08    | [CSGO](https://github.com/instantX-research/CSGO)                  | CSGO: Content-Style Composition in Text-to-Image Generation.            |[arXiv](https://arxiv.org/abs/2408.16766)  |   |
...
|    2024-08    | [Segment Anything Model 2 (SAM 2)](https://github.com/facebookresearch/segment-anything-2)                  | SAM 2: Segment Anything in Images and Videos.            |[arXiv](https://arxiv.org/abs/2408.00714)  |[Hugging Face](https://huggingface.co/facebook/sam2-hiera-large)  |
...
| Date          | Source                   | Description                                                 |   Paper   |  Model  |
| :------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------- | :-----------: | :-------: |
|    2024-11    | [LTX-Video](https://github.com/Lightricks/LTX-Video)                                              | LTX-Video is the first DiT-based video generation model that can generate high-quality videos in real-time.            |  |[Hugging Face](https://huggingface.co/Lightricks/LTX-Video)  |
|    2024-09    | [MIMO](https://github.com/menyifang/MIMO)                                              | MIMO: Controllable Character Video Synthesis with Spatial Decomposed Modeling.            |[arXiv](https://arxiv.org/abs/2409.16160)  |[Website](https://menyifang.github.io/projects/MIMO/index.html)  |
|    2024-09    | [DrawingSpinUp](https://github.com/LordLiang/DrawingSpinUp)                                              | DrawingSpinUp: 3D Animation from Single Character Drawings.            |[arXiv](https://arxiv.org/abs/2409.08615)  |[Website](https://lordliang.github.io/DrawingSpinUp/)  |
|    2024-09    | [ViewCrafter](https://github.com/Drexubery/ViewCrafter)                                              | ViewCrafter: Taming Video Diffusion Models for High-fidelity Novel View Synthesis.            |[arXiv](https://arxiv.org/abs/2409.02048)  |[Website](https://drexubery.github.io/ViewCrafter/)  |
...
| Date          | Source                   | Description                                                 |   Paper   |  Model  |
| :------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------- | :-----------: | :-------: |
|    2025-01    | [YuE](https://github.com/multimodal-art-projection/YuE)                | YuE: Open Full-song Generation Foundation Model, something similar to Suno.ai but open.                |                                                                                      |[Hugging Face](https://huggingface.co/m-a-p/YuE-s1-7B-anneal-en-cot)  |
...
| Date          | Source                   | Description                                                 |   Paper   |  Model  |
| :------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------- | :-----------: | :-------: |
|    2025-01    | [Hunyuan3D 2.0](https://github.com/Tencent/Hunyuan3D-2)                | Hunyuan3D 2.0: Scaling Diffusion Models for High Resolution Textured 3D Assets Generation.            |[arXiv](https://arxiv.org/abs/2501.12202)  |[Hugging Face](https://huggingface.co/tencent/Hunyuan3D-2)  |
|    2024-11    | [Hunyuan3D-1.0](https://github.com/Tencent/Hunyuan3D-1)                | Hunyuan3D-1.0: A Unified Framework for Text-to-3D and Image-to-3D Generation.            |[arXiv](https://arxiv.org/abs/2411.02293)  |[Hugging Face](https://huggingface.co/tencent/Hunyuan3D-1)  |
|    2024-09    | [3DTopia-XL](https://github.com/3DTopia/3DTopia-XL)                | 3DTopia-XL: Scaling High-quality 3D Asset Generation via Primitive Diffusion.            |[arXiv](https://arxiv.org/abs/2409.12957)  |[Website](https://3dtopia.github.io/3DTopia-XL/)  |
|    2024-08    | [ShapeSplat](https://github.com/qimaqi/ShapeSplat-Gaussian_MAE)                | ShapeSplat: A Large-scale Dataset of Gaussian Splats and Their Self-Supervised Pretraining.            |[arXiv](https://arxiv.org/abs/2408.10906)  |  |
